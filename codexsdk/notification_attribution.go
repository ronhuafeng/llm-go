...
var notificationAttribution = func() map[protocolv2.ServerNotificationKind]notificationAttributionClass {
	...
	add(notificationAttributionThread,
		...
		"thread/realtime/error", "thread/realtime/item/completed", "thread/realtime/item/started",
		"thread/realtime/item/transcript/delta", "thread/realtime/itemAdded", "thread/realtime/outputAudio/delta",
	...
	add(notificationAttributionGlobal,
		...
		"mcpServer/event/stream/notification", "mcpServer/oauthLogin/completed", "mcpServer/startupStatus/updated",
