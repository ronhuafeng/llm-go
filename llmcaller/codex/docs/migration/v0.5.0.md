# Migrating from llmcaller-codex-go to llm-go
...
bridge the repository paths. The replacement tag has passed its public-proxy
and clean-consumer release gates; update imports directly.
...
proxy. All three replacement modules have been released and verified, and the
legacy repository is archived.
