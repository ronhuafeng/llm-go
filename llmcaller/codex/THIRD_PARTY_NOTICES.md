...
| --- | --- | --- | --- | --- |
| `github.com/ronhuafeng/llm-go/llmkit` | `v0.10.0` | Direct | Go module declared in `go.mod`; provider-neutral typed request, schema, decode, validation, and retry primitives. | MIT |
