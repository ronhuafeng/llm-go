...
single Agent pass, and whether publication runs. The Go owner performs the
publication effect when Actions invokes it. For real drift, the workflow invokes
